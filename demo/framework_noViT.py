...
if __name__ == "__main__":
    ...
    while count < 3:
        ...
        for r in r_list:
            ...
            # resized_img = mask_img.resize((480, 320), resample=Image.NEAREST)
            ...
            # print(predictions.shape, predictions_rec.shape)
        ...
        #     pdb.set_trace()
            ...
            inputs_img = processor(images=pil_image, return_tensors="pt", padding=True)
        ...
        # Save .pt after each image to avoid losing progress
        torch.save(mse_all, "MSE_100.pt")
        torch.save(attn_all, "Attn_dist_100.pt")
